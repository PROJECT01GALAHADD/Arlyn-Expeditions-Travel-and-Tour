		...
		<div className="min-h-screen pt-20">
			<section className="relative h-[50vh] flex items-center justify-center mb-16">
				<div
					...
					style={{ backgroundImage: `url(/images/coron-ultimate-tour.png)` }}
				>
				...
				<div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
					...
					<p className="text-xl text-white max-w-2xl mx-auto drop-shadow-lg">
						Discover the breathtaking beauty of Coron's pristine islands and
						lagoons
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto px-4 md:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Discover the breathtaking beauty of Coron, Palawan through our
							carefully curated island tours
						</p>
					</div>
									...
									<img
										src={
											selectedTour.images && selectedTour.images.length > 0
												...
												: selectedTour.imageUrl || "/images/placeholder.jpg"
										}
										...
										<>
											...
											<button
												onClick={(e) => {
													e.stopPropagation();
													setCurrentImageIndex((prev) =>
														prev === selectedTour.images!.length - 1
															? 0
															: prev + 1,
													);
												}}
...
function TourCard({
	tour,
	onSelect,
}: { tour: Tour; onSelect: (tour: Tour) => void }) {
	return (
		<Card
		...
		>
			<div className="aspect-[4/3] relative overflow-hidden">
				<img
					src={tour.imageUrl || tour.images?.[0] || "/images/placeholder.jpg"}
					alt={tour.name}
