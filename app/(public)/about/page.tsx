					...
					<div className="max-w-3xl mx-auto mb-16">
						<Card className="p-8">
							...
							<p className="text-muted-foreground mb-4">
								Located in Barangay Poblacion 5, Coron, Palawan, Arlyn
								Expeditions Travel and Tour Services has been proudly serving
								travelers since our founding. Our passion for showcasing the
								natural beauty of Coron drives everything we do.
							</p>
							<p className="text-muted-foreground">
								From pristine lagoons to vibrant coral reefs, from thrilling
								wildlife encounters to peaceful sunset moments, we're dedicated
								to creating authentic experiences that connect you with the
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
							{[
								...
								},
								{
									...
									title: "Excellence",
									description:
										"Committed to delivering exceptional experiences every time",
								},
								{
								...
								},
								{
									...
									title: "Safety",
									description:
										"Your safety is our top priority on every adventure",
								},
							].map((value, index) => (
