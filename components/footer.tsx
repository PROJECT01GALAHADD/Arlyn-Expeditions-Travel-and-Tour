    ...
    <footer className="bg-[hsl(195,100%,25%)] text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          <div>
            <h3 className="text-2xl font-extrabold mb-4">Arlyn Expeditions Travel and Tours</h3>
            <p className="text-white/90 mb-4 leading-relaxed">
              Your trusted partner for unforgettable island adventures in Coron, Palawan. Explore pristine lagoons,
              dramatic limestone cliffs, and hidden beaches.
            </p>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
              ...
              />
              <Button type="submit" variant="secondary" data-testid="button-newsletter-submit">
                Subscribe
              </Button>
            </form>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/80">
            <p>&copy; {new Date().getFullYear()} Arlyn Expeditions Travel and Tours. All rights reserved.</p>
