...
const destinationImageMap: Array<{ keywords: string[]; image: string }> = [
  { keywords: ["kayangan lake", "kayangan"], image: "/images/kayangan-lake-boats.png" },
  { keywords: ["twin lagoon", "twin lagoons"], image: "/images/twin_lagoon_coron_pa_e9e1954c.jpg" },
  { keywords: ["barracuda lake", "barracuda"], image: "/images/barracuda_lake_coron_d0887624.jpg" },
  { keywords: ["siete pecados", "siete"], image: "/images/siete_pecados_marine_7c4cd2af.jpg" },
  { keywords: ["coral garden", "coral"], image: "/images/coral_garden_reef_sn_2dea9479.jpg" },
  { keywords: ["shipwreck", "wreck", "skeleton"], image: "/images/coron_shipwreck_unde_d2841811.jpg" },
  { keywords: ["malcapuya"], image: "/images/malcapuya_island_cor_e89c7dcb.jpg" },
  { keywords: ["banana island"], image: "/images/banana_island_coron__d224e4e3.jpg" },
  { keywords: ["mount tapyas", "tapyas"], image: "/images/mount_tapyas_coron_p_8373785f.jpg" },
  ...
  { keywords: ["cave", "pukaway"], image: "/images/limestone_cave_stala_d46149d6.jpg" },
];
...
async function updateTourImages() {
  ...
  for (const tour of allTours) {
    ...
    const finalGallery = gallery.length
      ? (gallery.includes(preview) ? gallery : [preview, ...gallery])
      : [preview];
    ...
    console.log(`✓ ${tour.name}: set preview=${preview} gallery=${finalGallery.join(", ")}`);
  }
